...
from 海外頁面.介面揣語料檔案 import 顯示合格的EXCEL與字格並建檔
from 海外頁面.介面揣語料檔案 import 刪除轉好的表
from 海外頁面.介面前臺 import 顯示語言漢字相同的音檔
from 海外頁面.介面前臺 import 細節頁顯示所有音檔
from 海外頁面.介面前臺 import 輸出同語言一漢字的所有音檔
...
# 	url(r'^上傳檔案$', 上傳檔案, name='上傳檔案'),
	...
	url('^(?P<語料編號>\d+)/顯示合格的EXCEL與字格並建檔', 顯示合格的EXCEL與字格並建檔, name='顯示合格的EXCEL與字格並建檔'),
	...
	url('^(?P<語言名稱>[^/]+)/(?P<漢字>[^/]+)/(?P<IPA>[^/]+)/輸出同語言一漢字的所有音檔$', 輸出同語言一漢字的所有音檔, name='輸出同語言一漢字的所有音檔'), 
	
	url(r'^details/(?P<語言名稱>[^/]+)/(?P<漢字>[^/]+)/(?P<IPA>[^/]+)/*$',細節頁顯示所有音檔, name='細節頁顯示所有音檔'),
